...
namespace PrintShareSolution.Data.Migrations
{
    ...
    [Migration("20210131153350_AddPages")]
            ...
            modelBuilder.Entity("PrintShareSolution.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "8c513fe6-90a0-4197-89c9-0cea95bb5e5e",
            ...
            modelBuilder.Entity("PrintShareSolution.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "5c9cfc11-2f03-4fcf-b7bf-da0c1bab1423",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEGBzhyxo0hBaX9CMZQZTrX4GGK67oAGX34eHdqTzfBj6gI10y7bhA9h5O7YiCCDKzA==",
            ...
            modelBuilder.Entity("PrintShareSolution.Data.Entities.HistoryOfUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ActionHistory = 0,
                            DateTime = new DateTime(2021, 1, 31, 22, 33, 49, 722, DateTimeKind.Local).AddTicks(9967),
                            FileName = "C://xxx.docx",
                            Pages = 0,
                            PrinterId = 1,
                            UserId = new Guid("69bd714f-9576-45ba-b5b7-f00649be00de")
