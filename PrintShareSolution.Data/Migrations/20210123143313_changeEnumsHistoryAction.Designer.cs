...
namespace PrintShareSolution.Data.Migrations
{
    ...
    [Migration("20210123143313_changeEnumsHistoryAction")]
    partial class changeEnumsHistoryAction
    {
            ...
            modelBuilder.Entity("PrintShareSolution.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "088403e4-00bc-4d84-859a-2908db823523",
            ...
            modelBuilder.Entity("PrintShareSolution.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "fbdab5b6-9325-46a7-a8ec-b96341e1aa55",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJvWD/jsiE0oP7oUezlCk/y8XkbSdjB+8QM8tHLHFYp/SB6p1RKJ/bG2nbx+DxUL0A==",
            ...
            modelBuilder.Entity("PrintShareSolution.Data.Entities.HistoryOfUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ActionHistory = 0,
                            DateTime = new DateTime(2021, 1, 23, 21, 33, 12, 633, DateTimeKind.Local).AddTicks(7411),
                            FileName = "C://xxx.docx",
                            PrinterId = 1,
                            UserId = new Guid("69bd714f-9576-45ba-b5b7-f00649be00de")
                        });
