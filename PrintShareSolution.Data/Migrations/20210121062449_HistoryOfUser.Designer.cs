...
namespace PrintShareSolution.Data.Migrations
{
    ...
    [Migration("20210121062449_HistoryOfUser")]
    partial class HistoryOfUser
    {
            ...
            modelBuilder.Entity("PrintShareSolution.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "f732d98f-d3e9-422e-9070-dab4c635289a",
            ...
            modelBuilder.Entity("PrintShareSolution.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "50f28690-7103-4279-a12a-ca634d3e1871",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEPKr1YQaUsSKnxuHdkc86Jc/ysFEH6blP+Iqt2lVlmU2xKgceIz8EP2GRAkgzz1gfQ==",
            ...
            modelBuilder.Entity("PrintShareSolution.Data.Entities.HistoryOfUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ActionHistory = 0,
                            DateTime = new DateTime(2021, 1, 21, 13, 24, 47, 926, DateTimeKind.Local).AddTicks(86),
                            FileName = "C://xxx.docx",
                            PrinterId = 1,
                            UserId = new Guid("69bd714f-9576-45ba-b5b7-f00649be00de")
                        });
